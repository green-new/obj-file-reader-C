...
*/
int fstart(FILE* fptr);

/** Initalizes a provided buffer with data from the line based on the expected dimensions and data format.
 ...
 * @returns 0 if the function completed successfuly, or a non-zero value if the function failed during conversion.
*/
